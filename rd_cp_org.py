...
import argparse
from rd_cp_org_test import evaluation, visualization, test
...
def train(_class_):
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, data in enumerate(dataloader):
           ...
           # noisy_img0 = addnoise_batch(img0,(40,40)) #use img,noisy_img for training M1,M2,M3 denoising modules
