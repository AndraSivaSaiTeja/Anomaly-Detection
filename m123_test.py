...
def train(_class_):
    ...
    weights_den = torch.load("/home/ai22mtech11001/Siva/other/checkpoints/model_dn1.pth")
    m1 = Dn1() 
    m2 = Dn2() 
    m3 = Dn3()
    m1 = m1.to(device)
    ...
    m0 = Dn0()
    m0 = m0.to(device)
    m0.load_state_dict(weights_den['m0'])
    ...
    for epoch in range(epochs):
        ...
        # dataloader = DataLoader(Repeat(train_data,3629), batch_size=batch_size, drop_last=True,
        #                     shuffle=True, num_workers=workers, collate_fn=cut_paste_collate_fn,
        #                     persistent_workers=True, pin_memory=True, prefetch_factor=5)
        ...
        #     loss1 = lf((clear_fmaps[0].detach()),(m1((noisy_fmaps[0].detach()))))#/(64*64*64)
        #     loss2 = lf((clear_fmaps[1].detach()),(m2((noisy_fmaps[1].detach()))))#/(128*32*32)
        #     loss3 = lf((clear_fmaps[2].detach()),(m3((noisy_fmaps[2].detach()))))#/(128*16*16)
        #     #print(1)
...
if __name__ == '__main__':
    ...
    setup_seed(111)
    item_list = ['bottle','cable','capsule','carpet','grid','hazelnut','leather','metal_nut','pill','screw','tile','toothbrush',\
