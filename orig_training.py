...
import argparse
from orig_test import evaluation, visualization, test
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, data in enumerate(dataloader):
           ...
           # clear_fmaps = encoder(img)
            ...
            inputs0 = encoder(img)
            inputs1 = encoder(noisy_img)
            outputs0 = decoder(bn(inputs0))
            outputs1 = decoder(bn(inputs1))
            loss0 = loss_function(inputs0,outputs0)
            loss1 = loss_function(inputs1,outputs1)
